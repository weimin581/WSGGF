function [q_wn,q_en,q_ws,q_es]=sidewindow_sideweighting_WNES_fast(I, p, r, eps, r2, s)
%%% I : guidance image
%%% p : input image
%%% r : filtering radius
%%% r2 : new radius
...
var_I_wn22 = mean_II_wn2 - mean_I_wn2 .* mean_I_wn2; %the 3*3 variance of image I
var_I_en22 = mean_II_en2 - mean_I_en2 .* mean_I_en2; %the 3*3 variance of image I
var_I_ws22 = mean_II_ws2 - mean_I_ws2 .* mean_I_ws2; %the 3*3 variance of image I
var_I_es22 = mean_II_es2 - mean_I_es2 .* mean_I_es2; %the 3*3 variance of image I
